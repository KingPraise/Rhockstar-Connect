...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed lg:sticky top-0 left-0 h-screen z-50 bg-slate-900/95 backdrop-blur-xl border-r border-rose-500/20 flex flex-col justify-between py-6 px-4 transition-all duration-300
