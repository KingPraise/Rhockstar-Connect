        ...
        <div className="flex-1 flex flex-col neo-card bg-slate-900/60 border border-white/5 rounded-3xl overflow-hidden shadow-2xl relative">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar">
            ...
            {messages.map((msg) => {
              ...
              return (
                <div key={msg.id} className={`flex items-start gap-2 ${isMe ? 'justify-end' : 'justify-start'} group relative`}>
                  {/* Action Menu Trigger (Hover / Focus) */}
                  ...
                  <div className={`max-w-[75%] rounded-2xl p-4 space-y-1 relative shadow-md ${
                    ...
                    <div className={`flex items-center justify-end gap-1.5 text-[10px] ${isMe ? 'text-slate-900/70 font-bold' : 'text-slate-400'}`}>
